    ...
    <div class="bg-white w-[50%] h-full flex flex-col items-center justify-center">
            ...
            <div class="space-y-4 mt-0 w-[70%]">
                @if(auth()->user() && auth()->user()->categoria === 'user')
                    <a href="{{ route('queue', 'triagem') }}" class="flex items-center gap-2 bg-[#527cd1] transition duration-300 text-white px-6 py-7 rounded hover:bg-[#8aabec] hover:text-[#eef4ff]"><img src="{{ asset('images/triagemico.png') }}" alt="atendente" class="w-14">gem</a>
